...
export const FullPageMenu = ({ isOpen, onClose }: FullPageMenuProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto flex h-full items-center px-4 py-20 md:px-8">
        <div className="grid w-full grid-cols-1 gap-16 lg:grid-cols-2 xl:gap-24">
          ...
          <div className="flex flex-col justify-center gap-8 lg:sticky lg:top-20">
